...
class EdgeClient:
    def __init__(self, args):
        ...
        self._load_camera_data = threading.Thread(target=self._load_camera_data)
        self._load_camera_data.start()

        time.sleep(200)
        print("over!")
        with open("edge_encodeAndInference_multi.txt", "a") as file:
            file.write(
