    ...
    def _edge_inference(self, frame_chunk):
        ...
        for num in range(rounds):
            ...
            if self.modelID == 'm':
                ...
                # pred_bantch_extra = self.yolo_m.predict(inference_data[:math.ceil(length / 3)], half=True, imgsz=height)
            elif self.modelID == 's':
...
if __name__ == '__main__':
    ...
    parser.add_argument("--loadtime", required=False, default=1, type=float,
                        help="loadtime")
    parser.add_argument("--loadtime_list", nargs="+", type=int, help="List of loadtime")
